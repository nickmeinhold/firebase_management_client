library googleapis.firebase.v1beta1.test;
...
checkUnnamed0(core.List<api.StreamMapping> o) {
...
checkUnnamed1(core.List<api.AndroidApp> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAndroidApp(o[0]);
  checkAndroidApp(o[1]);
}
...
checkUnnamed2(core.List<api.Location> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkLocation(o[0]);
  checkLocation(o[1]);
}
...
checkUnnamed3(core.List<api.ProjectInfo> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed4(core.List<api.FirebaseProject> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed5(core.List<api.IosApp> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkIosApp(o[0]);
  checkIosApp(o[1]);
}
...
checkUnnamed6(core.List<api.ShaCertificate> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed7(core.List<api.WebApp> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkWebApp(o[0]);
  checkWebApp(o[1]);
}
...
checkUnnamed9(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed10(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed11(core.List<api.FirebaseAppInfo> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildUnnamed13() {
  ...
  o.add(buildUnnamed12());
  o.add(buildUnnamed12());
  return o;
}

checkUnnamed13(core.List<core.Map<core.String, core.Object>> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUnnamed12(o[0]);
  checkUnnamed12(o[1]);
}
